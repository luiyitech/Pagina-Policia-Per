...
namespace Pagina_Policia_Per.Controllers
{
    public class NoticiasController : Controller
    {
        ...
        public static readonly List<Noticia> _allNoticias = new List<Noticia>
        {
            ...
            new Noticia { Id = 4, Titulo = "Incautaron Mercadería de Contrabando en Ruta 14", Resumen = "Personal de la Dirección de Prevención y Seguridad Vial detuvo un camión con electrónicos...", Contenido = "...", ImagenUrl = "/img/noticias/noticia4.jpg", FechaPublicacion = new DateTime(2025, 7, 22), Slug = "incautan-mercaderia-contrabando" },
            new Noticia { Id = 5, Titulo = "Reunión Clave con Vecinos del Barrio San Martín", Resumen = "El Jefe Departamental se reunió con la comisión vecinal para coordinar nuevas estrategias...", Contenido = "...", ImagenUrl = "/img/noticias/noticia5.jpg", FechaPublicacion = new DateTime(2025, 7, 20), Slug = "reunion-vecinos-san-martin" },
            new Noticia { Id = 6, Titulo = "Abierta la Inscripción para la Escuela de Oficiales", Resumen = "Se encuentra abierto el período de inscripción para el ciclo lectivo 2026...", Contenido = "...", ImagenUrl = "/img/noticias/noticia6.jpg", FechaPublicacion = new DateTime(2025, 7, 18), Slug = "inscripcion-escuela-oficiales" }
        };
